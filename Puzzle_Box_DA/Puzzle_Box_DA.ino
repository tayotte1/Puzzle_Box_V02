...
// Rotary Encoder
#define PIN_BUTTON1     3     // Button 1 for answer A, SWITCH01
#define PIN_BUTTON2     4     // Button 2 for answer B, SWITCH02
#define PIN_BUTTON3     5     // Button 3 for answer C, SWITCH03
...
void setup() {
  ...
  Serial.println("Puzzle Box V02 - Delores Ng and Andy Lowry");
...
// DA's Setup
  ...
  Serial.println("Starting...");    // Debug print
